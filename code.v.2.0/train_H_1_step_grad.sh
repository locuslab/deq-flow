...
python -u main.py --total_run 1 --start_run 1 --name deq-flow-H-naive-120k-C-36-1-1 \
...
python -u main.py --total_run 1 --start_run 1 --name deq-flow-H-naive-120k-T-40-1-1 \
